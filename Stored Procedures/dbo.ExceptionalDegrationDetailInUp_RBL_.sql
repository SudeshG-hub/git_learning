...
-- =============================================
CREATE PROCEDURE [dbo].[ExceptionalDegrationDetailInUp_RBL_]
...
set @parameterName_1 =(select ParameterName from dimparameter where DimParameterName = 'UploadFLagType' 
