...
----Select * 
from ENBD_TEMPDB.DBO.TempAdvSecurityDetail A
...
INNER JOIN ENBD_TEMPDB.DBO.TempAdvSecurityDetail AS T
...
AND NOT EXISTS (	SELECT	1 
					FROM	ENBD_TEMPDB.DBO.TempAdvSecurityDetail BB
...
SELECT @EntityKey=MAX(EntityKey) FROM  ENBD_MISDB.[dbo].[AdvSecurityDetail] 
...
,NULL ChargeNature
,RefCustomerId
FROM ENBD_TEMPDB.dbo.TempAdvSecurityDetail T 
