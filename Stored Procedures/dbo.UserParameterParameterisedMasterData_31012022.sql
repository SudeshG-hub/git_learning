...
CREATE PROCEDURE [dbo].[UserParameterParameterisedMasterData_31012022]
(
...
SET @TimeKey =(SELECT Timekey  FROM SysDayMatrix WHERE Cast(GETDATE() as date)=Cast([date] as date)) -- NITIN : 21 DEC 2010
SELECT CtrlName
					,FldName
					,FldCaption
					,FldDataType
