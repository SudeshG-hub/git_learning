...
CREATE   PROCEDURE [dbo].[Rpt-049_17-02-2023]
      @TimeKey AS INT,
	  @Cost    AS FLOAT,
	  @SelectReport AS INT
AS
...
,ISNULL(FIN.UnAppliedIntAmount,0)/@Cost        AS [IIS Today]
,ISNULL(FINPD.UnAppliedIntAmount,0)/@Cost      AS [IIS Yesterday]
,(ISNULL(FIN.UnAppliedIntAmount,0)-ISNULL(FINPD.UnAppliedIntAmount,0))/@Cost        AS [Change in IIS Today]
,ISNULL(FINLM.UnAppliedIntAmount,0)/@Cost      AS [IIS Last Month]
,ISNULL(FINLF.UnAppliedIntAmount,0)/@Cost      AS [IIS Last Fiscal Year End]
