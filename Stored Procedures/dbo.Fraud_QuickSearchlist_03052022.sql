...
CREATE PROC [dbo].[Fraud_QuickSearchlist_03052022]
                 ...
                 (
                     SELECT  --A.Account_ID
					       B.AccountEntityId
							...
							,(CASE WHEN cast(NPA_DateAtFraud as date) = '01/01/1900' THEN '' ELSE Convert(Varchar(10),NPA_DateAtFraud,103) END) as NPADateAtFraud
							,RFA_ReportingByBank
							...
							,convert(varchar(10),H.NPADt,103) as CurrentNPA_Date
