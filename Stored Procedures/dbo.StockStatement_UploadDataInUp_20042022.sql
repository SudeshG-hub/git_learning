...
CREATE PROCEDURE  [dbo].[StockStatement_UploadDataInUp_20042022]
	@Timekey INT,
...
--D2Ktimestamp
		...
		SELECT
                   ...
                   ,Case When StockStamentDt<>'' Then  Convert(date,StockStamentDt) Else NULL END as StockStamentDt
	...
	Insert Into #StockStatementUpload(CIF,CustomerLimitSuffix,FieldName)
	 ...
	 Select CIF, CustomerLimitSuffix,'StockStatement' FieldName from StockStatement_stg Where isnull(StockStamentDt,'')<>'' 
	...
	Where A.MenuId=@MenuId And A.IsVisible='Y'
		...
		print 'nanda4'
				 ...
				 IF OBJECT_ID('TEMPDB..#NEWTRANCHE')  IS NOT NULL
					...
					INNER JOIN #NEWTRANCHE B ON  US.CIF = SS.CIF AND US.CustomerLimitSuffix = SS.CustomerLimitSuffix
