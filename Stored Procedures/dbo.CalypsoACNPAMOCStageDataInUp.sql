...
BEGIN
   ...
   --         ,RestructureDate
	...
	Select InvestmentIDDerivativeRefNo, 'AdditionalProvisionAbsoluteinRs' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(AdditionalProvisionAbsoluteinRs,'')<>'' --AdditionalProvisionAbsoluteinRs Is not NULL
	UNION ALL
