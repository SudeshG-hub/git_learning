...
SET ANSI_NULLS ON
GO
Create PROC [dbo].[CollateralOwnerSearchList_New_Prod]
--Declare
			 ...
			 IF OBJECT_ID('TempDB..#temp') IS NOT NULL
                 ...
                 (
					 ...
					 Left Join (Select ParameterAlt_Key,ParameterName,'CustomeroftheBank' as Tablename 
						  ...
						  And EffectiveFromTimeKey<=(Select Timekey from SysDataMatrix where CurrentStatus='C') And EffectiveToTimeKey>=(Select Timekey from SysDataMatrix where CurrentStatus='C'))B
						  ...
						  And EffectiveFromTimeKey<=(Select Timekey from SysDataMatrix where CurrentStatus='C') And EffectiveToTimeKey>=(Select Timekey from SysDataMatrix where CurrentStatus='C'))C
						  ...
						  And G.EffectiveFromTimeKey<=(Select Timekey from SysDataMatrix where CurrentStatus='C') And G.EffectiveToTimeKey>=(Select Timekey from SysDataMatrix where CurrentStatus='C')

					 WHERE A.EffectiveFromTimeKey <= (Select Timekey from SysDataMatrix where CurrentStatus='C')
                           AND A.EffectiveToTimeKey >=(Select Timekey from SysDataMatrix where CurrentStatus='C')
