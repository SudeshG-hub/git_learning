...
cREATE PROCEDURE  [dbo].[CalypsoACNPAMOCStageDataInUp_29092022]
	@Timekey INT,
...
BEGIN
   ...
   --         ,RestructureDate
	...
	Select AccountID, 'POSinRs' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(POSinRs,'')<>'' --Is not NULL
	UNION ALL
	Select AccountID, 'InterestReceivableinRs' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(InterestReceivableinRs,'')<>'' --InterestReceivableinRs Is not NULL
	UNION ALL
	Select AccountID, 'AdditionalProvisionAbsoluteinRs' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(AdditionalProvisionAbsoluteinRs,'')<>'' --AdditionalProvisionAbsoluteinRs Is not NULL
	UNION ALL
	...
	--UNION ALL
	Select AccountID, 'FITLFlagYN' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(FITLFlagYN,'')<>'' --FITLFlagYN Is not NULL
	UNION ALL
	Select AccountID, 'DFVAmount' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(DFVAmount,'')<>'' --DFVAmount Is not NULL
	UNION ALL
	Select AccountID, 'RePossesssionFlagYN' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(RePossesssionFlagYN,'')<>'' --RePossesssionFlagYN Is not NULL
	UNION ALL
	Select AccountID, 'RePossessionDate' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(RePossessionDate,'')<>'' --RePossessionDate Is not NULL
	UNION ALL
	Select AccountID, 'InherentWeaknessFlag' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(InherentWeaknessFlag,'')<>'' --InherentWeaknessFlag Is not NULL
	UNION ALL
	Select AccountID, 'InherentWeaknessDate' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(InherentWeaknessDate,'')<>'' --InherentWeaknessDate Is not NULL
	UNION ALL
	Select AccountID, 'SARFAESIFlag' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(SARFAESIFlag,'')<>'' --SARFAESIFlag Is not NULL
	UNION ALL
	Select AccountID, 'SARFAESIDate' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(SARFAESIDate,'')<>'' --SARFAESIDate Is not NULL
	UNION ALL
	Select AccountID, 'UnusualBounceFlag' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(UnusualBounceFlag,'')<>'' --UnusualBounceFlag Is not NULL
	UNION ALL
	Select AccountID, 'UnusualBounceDate' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(UnusualBounceDate,'')<>'' --UnusualBounceDate Is not NULL
	UNION ALL
	...
	UNION ALL
	Select AccountID, 'FraudDate' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(FraudDate,'')<>'' --FraudDate Is not NULL
	UNION ALL
	Select AccountID, 'MOCSource' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(MOCSource,'')<>'' --MOCSource Is not NULL
	UNION ALL
	Select AccountID, 'MOCReason' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(MOCReason,'')<>'' --MOCReason Is not NULL
	UNION ALL
	Select AccountID, 'TwoFlag' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(TwoFlag,'')<>'' --TwoFlag Is not NULL
	UNION ALL
	Select AccountID, 'TwoDate' FieldName from CalypsoAccountLvlMOCDetails_stg Where isnull(TwoDate,'')<>'' --TwoDate Is not NULL
	UNION ALL
	...
	Where A.MenuId=24749 And A.IsVisible='Y'
