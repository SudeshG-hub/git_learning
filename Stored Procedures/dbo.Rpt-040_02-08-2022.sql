...
CREATE Procedure [dbo].[Rpt-040_02-08-2022]
@TimeKey  INT
AS
...
inner join DimProduct B on A.ProductCode=b.ProductCode inner join AdvAcBalanceDetail C
on A.AccountEntityId=C.AccountEntityId
inner join #DPD  on #DPD.AccountEntityID=a.AccountEntityID
