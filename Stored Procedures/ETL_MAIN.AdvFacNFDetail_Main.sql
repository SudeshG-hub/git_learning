...
----Select * 
from ENBD_TEMPDB.DBO.TempAdvFacNFDetail A
...
INNER JOIN ENBD_TEMPDB.DBO.TempAdvFacNFDetail AS T
...
AND NOT EXISTS (SELECT 1 FROM ENBD_TEMPDB.DBO.TempAdvFacNFDetail BB
...
SELECT @EntityKey=MAX(EntityKey) FROM  ENBD_MISDB.[dbo].[AdvFacNFDetail] 
...
,provision
,MarginAccNo
 FROM ENBD_TEMPDB.dbo.TempAdvFacNFDetail T 
