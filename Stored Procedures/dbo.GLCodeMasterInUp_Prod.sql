...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[GLCodeMasterInUp_Prod]
 ...
 SET @EffectiveFromTimeKey  = @TimeKey
	...
	PRINT 1
		...
		IF EXISTS(				                
					...
					UNION
					SELECT  1 FROM DimGL_Mod  WHERE (EffectiveFromTimeKey <=@TimeKey AND EffectiveToTimeKey >=@TimeKey)
															 AND GLCode=@GLCode
