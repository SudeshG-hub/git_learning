...
CREATE Procedure [dbo].[SecuritizedPoolInUp_Json_Backup_16032022]
...
Select 
 ...
 ,TotalInttReceivable,Action,InterestAccruedinRs
into #temp
...
MaturityDate varchar(20),NoOfAccount Int,TotalPosBalance Decimal(18,2), TotalInttReceivable Decimal(18,2) ,Action char(1),
