...
BEGIN
	...
	DECLARE @Timekey int = (SELECT TIMEKEY FROM ENBD_MISDB.DBO.AUTOMATE_ADVANCES WHERE EXT_FLG='Y')
...
------Select * 
--from ENBD_TEMPDB.DBO.TEMPDERVCANCEL_SOURCESYSTEM A
...
--INNER JOIN ENBD_TEMPDB.DBO.TEMPDERVCANCEL_SOURCESYSTEM AS T
...
--AND NOT EXISTS (SELECT 1 FROM ENBD_TEMPDB.DBO.TEMPDERVCANCEL_SOURCESYSTEM BB
...
SELECT		
		...
		,OverdueSinceDt 
		 ...
		 , EffectiveFromTimeKey
			...
			, DateApproved
			,DerivativeEntityID
		  FROM ENBD_TEMPDB.dbo.TEMPDERVCANCEL_SOURCESYSTEM T 
