...
CREATE PROCEDURE [dbo].[Rpt-050A_17-02-2023]	
    @TimeKey AS INT,
	@SelectReport AS INT
...
INNER JOIN	 Fraud_Details		FD							ON  IID.IssuerID=FD.RefCustomerID 
...
INNER JOIN Fraud_Details		FD				   ON  Derivative.CustomerID=FD.RefCustomerID 
													  AND FD.EffectiveFromTimeKey<=@TimeKey 
                                                      AND FD.EffectiveToTimeKey>=@TimeKey
