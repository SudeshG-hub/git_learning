...
CREATE   PROCEDURE [dbo].[Rpt-026_02-07-2022]
...
--DECLARE 
--    @DateFrom	AS VARCHAR(15)='01/03/2022',
...
declare @ProcessDate date,@TimeKey int
set @TimeKey=(select TimeKey from Sysdaymatrix where Date=@to1)
...
AND Convert(date,@ProcessDate,105) between @From1  AND  @to1
