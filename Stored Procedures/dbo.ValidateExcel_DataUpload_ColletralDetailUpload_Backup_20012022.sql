...
CREATE PROCEDURE [dbo].[ValidateExcel_DataUpload_ColletralDetailUpload_Backup_20012022]
@MenuID INT=10,  
					...
					BEGIN
					    Select @AccountID =AccountID,@Entity_Key=Entity_Key  from #tmp where RecentRownumber=@I 
							order By Entity_Key
							       ...
							       Select @AccountId=CustomerACID from advacbasicdetail where CustomerACID=@AccountID
								   IF @AccountId =''
								     BEGIN
										   Update UploadCollateralDetail
