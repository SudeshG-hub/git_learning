...
CREATE PROCEDURE [dbo].[Rpt-046_17-02-2023] 
   @TimeKey   AS INT
AS
...
SELECT DISTINCT
      ...
      ,CONVERT(VARCHAR(20),DATEADD(DD,30,RPPD.ReferenceDate),103)              AS [DaysPassedReviewPeriodDate]
      ...
      ,ACH.[Asset Classification]                                              AS [Asset Classification]
