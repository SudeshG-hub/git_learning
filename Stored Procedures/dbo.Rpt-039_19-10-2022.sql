...
CREATE PROC [dbo].[Rpt-039_19-10-2022]
	@TimeKey  INT,
	@SelectReport AS INT
	AS 
...
SELECT 
DISTINCT
CONVERT(VARCHAR(10),G.DATE,103)                                            AS CurrentProcessingDate
---------RefColumns---------
,H.SourceName
,A.UCIF_ID
...
,CONVERT(VARCHAR(20),ACND.NPADt,103)                                       AS SubSTD
,CONVERT(VARCHAR(20),ACND.DbtDt,103)                                       AS DB1
,A.NPA_Reason
