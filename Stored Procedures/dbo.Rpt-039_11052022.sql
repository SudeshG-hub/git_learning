...
CREATE PROC [dbo].[Rpt-039_11052022]
	@TimeKey  INT
	AS 
...
,D.SchemeType
,CONVERT(varchar(20),ACBD.AccountOpenDate,103)        AS AccountOpenDate
...
WHERE A.finalAssetClassAlt_key>1 AND A.EffectiveFromTimeKey<=@TimeKey  AND A.EffectiveToTimeKey>=@TimeKey 
