...
create PROC [dbo].[CalypsoCustomerLevelNPAMOCSearchList_19102022]
...
SELECT  
	...
	where AuthorisationStatus in('MP','NP','1A','A') AND UCICID=@UCICID
	...
	where AuthorisationStatus in('MP','NP') AND UCICID=@UCICID
...
BEGIN
	...
	where AuthorisationStatus in('1A') AND UCICID=@UCICID
