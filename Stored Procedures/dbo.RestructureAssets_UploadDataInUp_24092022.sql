...
CREATE PROCEDURE  [dbo].[RestructureAssets_UploadDataInUp_24092022]
	@Timekey INT,
...
--D2Ktimestamp
		...
		SELECT
                   ...
                   ,Case When isnull(DateofSigningICA,'')<>'' Then  Convert(date,DateofSigningICA,105) Else NULL END as DateofSigningICA
					,case when isnull(OSasondateofRstrctr,'')<>'' then cast(OSasondateofRstrctr as decimal(16,2))  else NULLIF(OSasondateofRstrctr,'') end OSasondateofRstrctr
                   ,case when isnull(POSasondateofRstrctr,'')<>'' then cast(POSasondateofRstrctr as decimal(16,2))  else NULLIF(POSasondateofRstrctr,'') end as POSasondateofRstrctr
                   ,InvestmentGrade
