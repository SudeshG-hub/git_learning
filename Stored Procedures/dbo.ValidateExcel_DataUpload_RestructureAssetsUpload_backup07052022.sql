...
CREATE PROCEDURE [dbo].[ValidateExcel_DataUpload_RestructureAssetsUpload_backup07052022]  
@MenuID INT=10,  
...
---------------------------------------------------------------------------------------------------------------------
 ...
 --WHERE ISNULL(CovidMoratoriamMSME,'')=''
  ...
  UPDATE RestructureAssets
   ...
   FROM RestructureAssets V  
 WHERE ISNULL(TypeofRestructuring,'') IN('MSME_Old Circular' , 'MSME_Covid Circular') AND ISNULL(CovidMoratoriamMSME,'') NOT IN('Y','N','NA')
