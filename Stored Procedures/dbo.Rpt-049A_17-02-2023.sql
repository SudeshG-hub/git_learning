...
CREATE PROCEDURE [dbo].[Rpt-049A_17-02-2023]	
    @TimeKey AS INT,
	@Cost AS FLOAT,
	@SelectReport AS INT
...
ISNULL(IFD.Interest_DividendDueAmount,0)/@Cost                             AS [IIS Today],
ISNULL(IFDPD.Interest_DividendDueAmount,0)/@Cost                           AS [IIS Yesterday],
(ISNULL(IFD.Interest_DividendDueAmount,0)-ISNULL(IFDPD.Interest_DividendDueAmount,0))/@Cost                             AS [Change in IIS Today],
ISNULL(IFDLM.Interest_DividendDueAmount,0)/@Cost                           AS [IIS Last Month],
ISNULL(IFDLF.Interest_DividendDueAmount,0)/@Cost                           AS [IIS Last Fiscal Year End],
'Investment'                                                               AS Flag
