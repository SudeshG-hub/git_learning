...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[DimInstrumentTypeMaster_InUp_Backup_26112021]
...
*/	
	...
	PRINT 1
		-----CHECK DUPLICATE
		IF EXISTS(				                
					SELECT  1 FROM DimInstrumentTypeMapping WHERE InstrumentTypeMappingAlt_Key=@InstrumentTypeMappingAlt_Key
					                                  and SrcSysInstrumentTypeCode=@SrcSysInstrumentTypeCode
