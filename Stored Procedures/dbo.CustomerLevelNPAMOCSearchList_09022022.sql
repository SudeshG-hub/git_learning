...
SET ANSI_NULLS ON
GO
create PROC [dbo].[CustomerLevelNPAMOCSearchList_09022022]
...
DROP TABLE IF EXISTS #CUST_POSTMOC
 ...
 --   FROM MOC_ChangeDetails A
	...
	@DateApproved as DateApproved,@ApprovedByFirstLevel as ApprovedByFirstLevel,
	@DateApprovedFirstLevel as DateApprovedFirstLevel,@MOC_ExpireDate MOC_ExpireDate,@MOC_TYPEFLAG MOCType_Flag,MOCType,B.SourceSystemAlt_Key as SourceSystemAlt_Key1
...
--
	...
	B.UCIF_ID as UCICID,AddlProvAbs as AdditionalProvision,@AuthorisationStatus as AuthorisationStatus,@MocReason as MOCReason_1,
	@MOCSourceAltkey as MOCSourceAltkey,@CreatedBy as CreatedBy,

	@DateCreated as DateCreated,@ModifiedBy as ModifiedBy,@DateModified as DateModified,@ApprovedBy as ApprovedBy,
	@DateApproved as DateApproved
	,@ApprovedByFirstLevel as ApprovedByFirstLevel,@DateApprovedFirstLevel as DateApprovedFirstLevel,
	@MOC_ExpireDate MOC_ExpireDate,@MOC_TYPEFLAG MOCType_Flag,MOCType,B.SourceSystemAlt_Key as SourceSystemAlt_Key1,Convert(Varchar(50),'') SourceSystemAlt_Key
		,0 as MOCReason
	 FROM MOC_ChangeDetails A
		INNER JOIN CustomerBasicDetail B
