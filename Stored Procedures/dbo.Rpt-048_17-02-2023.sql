...
CREATE PROCEDURE [dbo].[Rpt-048_17-02-2023]
      @TimeKey AS INT
AS
...
,DATEDIFF(DD,OriginalDCCO,RevisedDCCO)                        AS [Days Delayed]
,DPCD.ParameterName                                           AS [Delay Reason :Legal/Arbitration; Beyond Control]
,CONVERT(VARCHAR(20),RevisedDCCO,103)                         AS [Permitted Delay Date]	
,DATEDIFF(DD,RevisedDCCO,ActualDCCO_Date)                     AS [Days in Excess of Permitted Delay Date]	
