...
CREATE PROCEDURE [dbo].[Rpt-032_17-02-2023]
         @FromDate  VARCHAR(20)  
        ,@ToDate  VARCHAR(20) 
...
WHERE EffectiveFromTimeKey <= @FromTimeKey and EffectiveToTimeKey >= @FromTimeKey  AND RefCustomerID=@CustomerID
...
INTO #DPD1
FROM pro.AccountCal_Hist
WHERE EffectiveFromTimeKey <= @ToTimeKey and EffectiveToTimeKey >= @ToTimeKey  AND RefCustomerID=@CustomerID
