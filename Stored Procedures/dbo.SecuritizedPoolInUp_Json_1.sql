...
CREATE Procedure [dbo].[SecuritizedPoolInUp_Json_1]
...
Select 
 ...
 SecuritisationReckoningDate,SecuritisationMarkingDate,MaturityDate,NoOfAccount,TotalPosBalance
 ,TotalInttReceivable,InterestAccruedinRs
into #temp

From OPENJSON(@jsondata) with 
(
UploadID Int ,SummaryID int,PoolID varchar(max),PoolName varchar(max),SecuritisationType varchar(max),NoOfAccount Int,
POS decimal (18,2)
,SecuritisationExposureAmt	decimal	(18,2),SecuritisationReckoningDate varchar(20),SecuritisationMarkingDate varchar(20),
MaturityDate varchar(20),TotalPosBalance Decimal(18,2), TotalInttReceivable Decimal(18,2) ,
InterestAccruedinRs Decimal(18,2)
)
