...
CREATE PROCEDURE [dbo].[ValidateExcel_DataUpload_ColletralDetailUpload_Backup_24012022]
@MenuID INT=10,  
...
BEGIN
   ...
   UPDATE UploadCollateralDetail
	SET  
        ErrorMessage=CASE WHEN ISNULL(ErrorMessage,'')='' THEN 'Invalid value in column ‘Collateral Sub Type’. Kindly enter the values as mentioned in the ‘Collateral Sub Type’ master and upload again. Click on ‘Download Master value’ to download the valid values for the column'     
