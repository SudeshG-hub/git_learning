...
CREATE PROC [dbo].[Rpt-023_17-02-2023]
	@TimeKey  INT
	AS
...
SELECT A.CustomerID,A.CustomerEntityID,B.ChangeField ,A.CustomerName
 ...
 LEFT JOIN CustomerLevelMOC_Mod B ON A.CustomerID=B.CustomerID
...
OPTION(RECOMPILE)
 ...
 SELECT  A.CustomerID  CustomerID
		...
		,CASE WHEN A.ChangeFld=2		      THEN ISNULL(D.AssetClassShortNameEnum,'') 
		      WHEN A.ChangeFld=3		      THEN CONVERT(VARCHAR(20),B.NPADt ,103)
