...
SET ANSI_NULLS ON
GO
CREATE Procedure [dbo].[SecuritizedPoolInUp_Json_Backup_11032022]
...
Select 
 ...
 SecuritisationReckoningDate,SecuritisationMarkingDate,MaturityDate,NoOfAccount,TotalPosBalance,TotalInttReceivable
into #temp
...
MaturityDate varchar(20),NoOfAccount Int,TotalPosBalance Decimal(18,2), TotalInttReceivable Decimal(18,2)	
)
