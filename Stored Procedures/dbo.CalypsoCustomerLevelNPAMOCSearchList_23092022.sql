...
CREATE PROC [dbo].[CalypsoCustomerLevelNPAMOCSearchList_23092022]
...
SELECT			B.InvEntityId,B.RefIssuerID as CustomerID ,I.IssuerName as CustomerName ,
...
SELECT			B.DerivativeEntityID,B.CustomerID ,B.CustomerName,
...
DROP TABLE IF EXISTS #CUST_POSTMOC
	...
	SELECT   A.CustomerEntityID,B.RefIssuerID as CustomerID,C.IssuerName as CustomerName ,FinalAssetClassAlt_Key as AssetClassAlt_Key, A.NPADate,A.SecurityValue SecurityValue,
	...
	,Convert(Varchar(50),'') SourceSystemAlt_Key
	,0 as MOCReason
	...
	INSERT  INTO  #CUST_POSTMOC	
		...
		SELECT		B.IssuerEntityId,C.IssuerID,C.IssuerName,A.AssetClassAlt_Key,A.NPA_Date,A.CurntQtrRv  SecurityValue,
					...
					@MOC_ExpireDate MOC_ExpireDate,@MOC_TYPEFLAG MOCType_Flag,MOCType,C.SourceAlt_key as SourceSystemAlt_Key1,Convert(Varchar(50),'') SourceSystemAlt_Key
					,0 as MOCReason
		...
		SELECT		B.DerivativeEntityID,B.CustomerId,B.CustomerName,A.AssetClassAlt_Key,A.NPA_Date,A.CurntQtrRv  SecurityValue,
