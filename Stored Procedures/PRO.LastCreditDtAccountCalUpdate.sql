...
SELECT CustomerAcID,AccountEntityId,TxnDate,SUM(TxnAmount)TxnAmount FROM DBO.AcDailyTxnDetail 

Where TxnDate=@Date And  TxnSubType='RECOVERY'  and AccountEntityId>0
and TrueCredit = 'Y'
