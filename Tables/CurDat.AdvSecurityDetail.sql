...
GO
ALTER TABLE [CurDat].[AdvSecurityDetail] ADD CONSTRAINT [CK__AdvSecuri__Effec__4BA21D88] CHECK (([EffectiveToTimeKey]=(49999)))
GO
ALTER TABLE [CurDat].[AdvSecurityDetail] ADD CONSTRAINT [AdvSecurityDetail_SecurityEntityID] PRIMARY KEY NONCLUSTERED ([SecurityEntityID], [EffectiveFromTimeKey], [EffectiveToTimeKey]) ON [PRIMARY]
GO
