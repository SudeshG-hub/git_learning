...
GO
ALTER TABLE [CurDat].[AdvSecurityValueDetail] ADD CONSTRAINT [CK__AdvSecuri__Effec__4C9641C1] CHECK (([EffectiveToTimeKey]=(49999)))
GO
ALTER TABLE [CurDat].[AdvSecurityValueDetail] ADD CONSTRAINT [AdvSecurityValueDetail_SecurityEntityID] PRIMARY KEY NONCLUSTERED ([SecurityEntityID], [EffectiveFromTimeKey], [EffectiveToTimeKey]) ON [PRIMARY]
GO
