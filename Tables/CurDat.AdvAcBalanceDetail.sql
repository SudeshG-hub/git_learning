...
GO
ALTER TABLE [CurDat].[AdvAcBalanceDetail] ADD CONSTRAINT [CK__AdvAcBala__Effec__34BEB830] CHECK (([EffectiveToTimeKey]=(49999)))
GO
ALTER TABLE [CurDat].[AdvAcBalanceDetail] ADD CONSTRAINT [AdvAcBalanceDetail_Cur_AccountEntityID] PRIMARY KEY NONCLUSTERED ([AccountEntityId], [EffectiveFromTimeKey], [EffectiveToTimeKey]) ON [PRIMARY]
GO
CREATE CLUSTERED INDEX [AdvAcBalanceDetail_ClsIdx] ON [CurDat].[AdvAcBalanceDetail] ([EntityKey]) ON [PRIMARY]
GO
