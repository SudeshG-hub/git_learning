...
GO
ALTER TABLE [CurDat].[AdvAcFinancialDetail] ADD CONSTRAINT [CK__AdvAcFina__Effec__388F4914] CHECK (([EffectiveToTimeKey]=(49999)))
GO
ALTER TABLE [CurDat].[AdvAcFinancialDetail] ADD CONSTRAINT [AdvAcFinancialDetail_AccountEntityID] PRIMARY KEY NONCLUSTERED ([AccountEntityId], [EffectiveFromTimeKey], [EffectiveToTimeKey]) ON [PRIMARY]
GO
