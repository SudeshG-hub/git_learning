...
GO
ALTER TABLE [PRO].[AccountCal_Main] ADD CONSTRAINT [CK__AccountCa__Effec__1E6F845E] CHECK (([EffectiveToTimeKey]=(49999)))
GO
ALTER TABLE [PRO].[AccountCal_Main] ADD CONSTRAINT [AccountCal_Main_AccountEntityID] PRIMARY KEY NONCLUSTERED ([AccountEntityID], [EffectiveFromTimeKey], [EffectiveToTimeKey]) ON [PRIMARY]
GO
CREATE CLUSTERED INDEX [AccountCal_Main_ClsIdx] ON [PRO].[AccountCal_Main] ([EntityKey]) ON [PRIMARY]
GO
