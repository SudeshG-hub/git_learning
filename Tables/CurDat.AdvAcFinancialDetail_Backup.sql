CREATE TABLE [CurDat].[AdvAcFinancialDetail_Backup]
(
...
GO
ALTER TABLE [CurDat].[AdvAcFinancialDetail_Backup] ADD CONSTRAINT [CK__AdvAcFina__Effec__39836D4D] CHECK (([EffectiveToTimeKey]=(49999)))
GO
ALTER TABLE [CurDat].[AdvAcFinancialDetail_Backup] ADD CONSTRAINT [AdvAcFinancialDetailbackup_AccountEntityID] PRIMARY KEY NONCLUSTERED ([AccountEntityId], [EffectiveFromTimeKey], [EffectiveToTimeKey]) ON [PRIMARY]
GO
